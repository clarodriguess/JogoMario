...
## ✅ Funcionalidades
* Animação de pulo com CSS
* Detecção de colisão com lógica JavaScript
* Interrupção do jogo ao colidir
* Troca de imagem do Mario ao perder
* Loop contínuo de verificação do jogo (game loop)
...
O objetivo é desviar do cano (pipe) que se move da direita para a esquerda.<br>
Se o Mario bater no obstáculo, o jogo termina com uma animação de "game over".
